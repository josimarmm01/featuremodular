...
fun LoginScreen(
    ...
    val isApiError = uiState is LoginUiState.Error
    val apiErrorMessage = (uiState as? LoginUiState.Error)?.message
            ...
            Column(
                ...
                Button(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(50.dp),
                    enabled = isEmailValid && isPasswordValid && uiState !is LoginUiState.Loading,
                    colors = ButtonDefaults.buttonColors(
                        containerColor = if (isEmailValid && isPasswordValid && uiState !is LoginUiState.Loading) {
